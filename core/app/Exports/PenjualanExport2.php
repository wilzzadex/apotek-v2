...
class PenjualanExport2 implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping, WithStyles
{
    use Exportable;
    ...
    */
     ...
     {
         return Penjualan_Obat::whereBetween('tgl_transaksi',[$this->tanggal_awal,$this->tanggal_akhir])->get();
