...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="{{ asset('assets/backend') }}/css/pages/login/login-1.css" rel="stylesheet" type="text/css" />
				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<a href="" class="text-center mb-10">
							<img src="{{ asset('file_ref/pengaturan_aplikasi/'.$pengaturan->logo_aplikasi) }}" class="max-h-100px" alt="" />
						</a>
						<!--end::Aside header-->
						<!--begin::Aside title-->
					...
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url({{ asset('assets/backend') }}/media/svg/illustrations/login-visual-1.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
						...
						<div class="login-form login-signin">
							...
							<form class="form" novalidate="novalidate" id="kt_login_signin_form">
								...
								<div class="pb-lg-0 pb-5">
									<button type="button" id="kt_login_signin_submit" data-admin={{ route('back.dashboard') }} data-url={{ route('post.login') }} class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Masuk</button>
